    ...
    <div className="min-h-[80vh] bg-[#F6FDFE]">
      <div className="flex justify-center items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 justify-center items-center gap-10">
          <div className="m-10" data-aos="slide-right" data-aos-duration="2000">
            <img src={aboutus} alt="" className="rounded-xl min-h-[500px]" />
          </div>
          <div
            data-aos="slide-left"
            data-aos-duration="2000"
            className="flex flex-col justify-center items-start  gap-5 m-10"
          >
            ...
            <p className="text-start text-slate-800 ">
              ...
              development. <br /> <br /> Our dedication illuminates pathways to
              brighter futures, impacting communities across Ethiopia. Through
